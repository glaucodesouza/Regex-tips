...
console.log(text1.match(/\d{1,2}/g)); //apenas números c/ 1 ou dois dígitos
console.log(text1.match(/[0-9]{2}/g)); //apenas números com 2 dígitos
console.log(text1.match(/\d{1,}/g)); //apenas números c/ 1 ou mais dígitos
